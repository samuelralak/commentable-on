...
Gem::Specification.new do |spec|
  ...
  spec.summary       = %q{Provides comment functionality with replies}
  spec.description   = %q{Placeholder description text explaining how commentable on steroids will save the world in 5 words or less}
